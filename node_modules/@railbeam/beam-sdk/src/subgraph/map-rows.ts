...
function mapMetadataRow(m: Record<string, unknown>): SubgraphAgentMetadata {
  return {
    id: String(m.id),
...
export function mapAgentRow(raw: Record<string, unknown>): SubgraphAgent {
...
export function mapFeedbackRow(raw: Record<string, unknown>): SubgraphFeedback {
  return {
    id: String(raw.id),
    agentId: parseBigIntString(String(raw.agentId)),
...
export function mapValidationRow(raw: Record<string, unknown>): SubgraphValidation {
  return {
    id: String(raw.id),
