...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-full max-w-[calc(100vw-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto overscroll-contain rounded-lg border bg-background p-4 shadow-lg duration-150 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 max-h-[min(90dvh,calc(100dvh-2rem))] sm:max-h-[min(90dvh,calc(100dvh-4rem))] sm:max-w-lg sm:p-6",
        className,
      )}
      {...props}
    >
...
/** Scrollable region for flex-column dialogs (fixed header/footer). */
