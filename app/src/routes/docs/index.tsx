    ...
    <DocProse>
      ...
      <DocSection title="At a glance">
        ...
        <DocCallout title="Packages" variant="info">
          <p>
            Runtime code lives in <code className="text-foreground">@railbeam/beam-sdk</code>. Shared request and response
            shapes are published from <code className="text-foreground">@railbeam/stardorm-api-contract</code> — import
